...
export const EXPORT_THEME_PRESETS: ExportThemePreset[] = [
  {
    ...
    heading_border_cell_colors: ['#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff'],
  ...
  },
  {
    ...
    heading_border_cell_colors: ['#dbeafe', '#e8f1ff', '#f1f7ff', '#f6faff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff'],
  ...
  },
  {
    ...
    heading_border_cell_colors: ['#eaf7ff', '#f2fbff', '#f7fdff', '#fbfeff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff'],
  ...
  },
  {
    ...
    heading_border_cell_colors: ['#dcfce7', '#e9fbed', '#f1fcf4', '#f7fdf8', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff'],
  ...
  },
  {
    ...
    heading_border_cell_colors: ['#eaf8ee', '#f2fbf4', '#f7fdf8', '#fbfefc', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff'],
  ...
  },
  {
    ...
    heading_border_cell_colors: ['#fff3d6', '#fff7e6', '#fffaf0', '#fffdf8', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff'],
  ...
  },
  {
    ...
    heading_border_cell_colors: ['#f2edff', '#f6f2ff', '#faf7ff', '#fdfbff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff'],
...
export function applyExportLayoutPreset(config: ExportFormatConfig, presetId: string): ExportFormatConfig {
  ...
  return {
    ...
    headings: config.headings.map((current, index) => ({
      ...current,
      // 预设仅定义到 6 级，7-9 级沿用预设最深层级样式
      ...(preset.headings[index] || preset.headings[preset.headings.length - 1] || {}),
