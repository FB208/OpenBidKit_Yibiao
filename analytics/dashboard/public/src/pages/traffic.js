...
const pageLabels = {
  ...
  'technical-plan/document-analysis': '标书生成 - 上传招标文件',
  'technical-plan/generation-settings': '标书生成 - 生成设置',
  'technical-plan/bid-analysis': '标书生成 - 招标文件解析',
  'technical-plan/outline-generation': '标书生成 - 目录生成',
  'technical-plan/global-facts': '标书生成 - 全局事实设定',
  'technical-plan/content-edit': '标书生成 - 生成正文',
  'technical-plan/expand': '标书生成 - 扩写改写',
